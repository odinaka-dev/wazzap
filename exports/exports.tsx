// exports of all the client side pages inside the app directory
export { default as Chats } from "@/pages/user/chats";
export { default as Groups } from "@/pages/user/groups";
